...
export default function CollectionsPanel({
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
        ...
        <div className="flex items-center gap-2.5 flex-wrap">
          ...
          {selectedDb && (
            <>
              ...
              <span className="inline-flex items-center gap-1.5 text-[11px] font-bold text-white bg-[#0d3d26] px-2.5 py-0.5 rounded-full">
        ...
        <div className="flex items-center gap-2">
          ...
          {selectedDb && (
            <button
              ...
              className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl text-white text-xs font-semibold transition-all shadow-sm"
      ...
      <div className="p-5">
        {!selectedDb ? (
          <EmptyState icon={<ArrowSvg />} message="Select a database" sub="Click a database on the left to view its collections" className="py-20" />
        ) : loading ? (
