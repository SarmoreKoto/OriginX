      ...
      <div className="p-6">
        ...
        <div className="flex items-start justify-between mb-6">
          <div className="flex items-center gap-4">
            {/* Icon box — matching the teal/green square in screenshot */}
            <div className="w-12 h-12 rounded-2xl flex items-center justify-center shadow-sm flex-shrink-0" style={{ background: "#0d3d26" }}>
            ...
            <div>
              ...
              <div className="flex items-center gap-1.5 mt-0.5">
                ...
                <p className="text-sm text-gray-500">Manage your MongoDB databases and collections</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            {!loadingDbs && databases.length > 0 && (
              <div className="flex items-center gap-1.5 text-xs font-semibold text-[#0d3d26] bg-[#f0faf4] border border-green-200 px-3 py-1.5 rounded-full">
                <span className="w-2 h-2 rounded-full bg-green-500 inline-block" />
        ...
        {/* ── Two-column layout: DB panel + Collections ── */}
        ...
        {selectedCollection && selectedDb && (
          <div className="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
              ...
              {/* Add Items button — matches screenshot's "+ Add New User" style */}
              {!showInsertForm && (
                <button
                  onClick={() => setShowInsertForm(true)}
                  className="flex items-center gap-2 px-5 py-2.5 rounded-xl text-white text-sm font-bold transition-all shadow-md active:scale-95"
